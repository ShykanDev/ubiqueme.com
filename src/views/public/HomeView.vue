...
<template>
  <HomeLayout>
    <template #main>
      <main class="relative bg-[#070b14] overflow-hidden font-google-sans">
        
        <!-- 📐 BACKGROUND ORNAMENTATION (Blueprint Style) -->
        <div class="absolute inset-0 z-0">
          <div class="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] border border-white/5 rounded-full pointer-events-none"></div>
          <div class="absolute top-[-5%] right-[-5%] w-[400px] h-[400px] border border-white/5 rounded-full pointer-events-none"></div>
        ...
        <section class="relative z-10 px-8 md:px-24 pt-32 pb-20 mx-auto max-w-7xl">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative">
              ...
              <div class="relative aspect-square rounded-[3rem] overflow-hidden border border-white/10 bg-white/5 shadow-2xl group">
