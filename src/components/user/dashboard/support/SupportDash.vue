...
<template>
  <div class="w-full max-w-7xl mx-auto font-google-sans">
    <div class="mb-6">
      ...
      <p class="text-sm text-gray-400">¿Tienes algún problema? Envíanos un correo y te ayudaremos lo antes posible.</p>
    </div>
      ...
      <form @submit.prevent="submitForm" class="space-y-5 relative">
        ...
        <div>
          ...
          <textarea v-model="form.message" required rows="5"
            ...
            placeholder="Describe tu problema con detalle para que podamos ayudarte de la mejor manera..."></textarea>
        </div>
        ...
        <button type="submit" :disabled="isSending"
          ...
          <svg v-if="isSending" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="mt-6 flex items-center justify-center gap-2 text-xs text-gray-500">
      ...
      También puedes escribirnos enviando un correo directo a: <a href="mailto:soporte@ubiqueme.com"
        class="text-blue-400 hover:underline">soporte@ubiqueme.com</a>
    </div>
  </div>
</template>
