  ...
  <div class="w-full max-w-7xl mx-auto font-google-sans pb-20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2 space-y-6">
        <!-- Card: Perfil -->
        <div class="bg-[#0f0f11] rounded-2xl p-6 border border-white/5">
          ...
          <div class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  class="w-full bg-[#161618] border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-amber-500/50 transition-all"
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full bg-[#161618] border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none opacity-60 cursor-not-allowed"
                  disabled
                />
              </div>
            </div>
            <div class="pt-4 flex justify-end">
              <button
                class="px-6 py-2.5 rounded-xl text-sm font-medium bg-amber-600 hover:bg-amber-500 text-white transition-all active:scale-[0.98]"
              >
                Guardar cambios
              </button>
            </div>
        ...
        <div class="bg-[#0f0f11] rounded-2xl p-6 border border-white/5 relative overflow-hidden">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="p-4 bg-[#161618] rounded-xl border border-white/5">
          ...
          <div class="mt-6 pt-4 border-t border-white/5 flex flex-wrap gap-3">
            <button class="text-sm font-medium text-amber-400 hover:text-amber-300 transition-colors">Ver historial de facturas</button>
        ...
        <div class="bg-[#0f0f11] rounded-2xl p-6 border border-white/5">
          ...
          <div class="space-y-4">
            <button 
              ...
              class="w-full flex items-center justify-between p-4 bg-[#161618] hover:bg-white/5 border border-white/5 rounded-xl transition-all group"
            >
              <div class="text-left">
                <p class="text-sm font-medium text-white group-hover:text-amber-400 transition-colors">Recuperar Contraseña</p>
            ...
            <label class="flex items-center justify-between cursor-pointer group p-4 bg-[#161618] border border-white/5 rounded-xl">
              <div>
